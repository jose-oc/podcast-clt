"""Main entry point for podcast-cli Typer application."""
...
from podcast_cli.cli.commands.cache import cache_app
from podcast_cli.cli.commands.inspect import inspect_command
from podcast_cli.cli.commands.mapping import mapping_app
...
def _version_callback(value: bool) -> None:
    if value:
        console.print(f"[bold cyan]podcast-cli[/bold cyan] version [bold white]v{__version__}[/bold white]")
        raise typer.Exit()
