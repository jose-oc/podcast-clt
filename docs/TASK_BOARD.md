...
| **Phase 2c** | KB vector embeddings (local default, optional cloud adapters) + hybrid fusion | ✅ Completed | `docs/KNOWLEDGE_BASE_DESIGN.md` → `docs/KNOWLEDGE_BASE.md` | `tests/test_kb_embeddings.py` |
